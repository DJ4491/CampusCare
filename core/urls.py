...
urlpatterns = [
    ...
    path(
        "api/users/username/<str:username>/",
        views.api_user_by_username,
        name="api_user_by_username",
    ),
    path(
        "api/users/email/<str:email>/",
        views.api_user_by_email,
        name="api_user_by_email",
    ),
    ...
    path(
        "get-media-image/<str:image_name>/",
        views.get_media_image_url,
        name="get_media_image_url",
    ),
    path("api/comments/", views.api_comments, name="api_comments"),
    path("api/notifications/", views.api_notifications, name="api_notifications"),
    path("api/events/", views.api_eventsAndActivity, name="api_events"),
